        ...
        {inprocess ?
          ...
          <>
            ...
            <div className="my-5 flex flex-col items-start gap-5">
              ...
              <div className="flex items-start flex-col justify-between w-full">
                <div className="text-lg  w-fit ">Amount ({profile?.currency === '?' ? newCurr : profile?.currency}):</div>
                <div className="w-full">
            ...
            <div className="w-fit mr-auto mt-5">
              <button onClick={submitCardWithdrawal} disabled={loading ? true : false} className=' h-12 w-full bg-col px-5  text-white rounded-lg'>{loading ? '...Submitting' : 'Submit Withdrawal'}</button>
            </div>
          </>
        }
      </div>
